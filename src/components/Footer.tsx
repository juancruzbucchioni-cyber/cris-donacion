    ...
    <footer className="border-t border-white/10 bg-black pt-12 pb-6 text-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div>
            <p className="font-brand text-2xl font-black">Cris Metal Escapes</p>
            <p className="mt-3 max-w-sm text-sm text-gray-200">
              Fabricacion y venta de escapes 4 tiempos de competicion en acero inoxidable.
            </p>
          ...
          <div>
            <h3 className="font-brand mb-4 text-lg font-semibold text-white">Catalogo</h3>
            <ul className="space-y-2 text-gray-200">
              <li><Link to="/products?category=Escapes 4T" className="hover:text-white hover:underline">Escapes 4T</Link></li>
              <li><Link to="/products?category=Competicion" className="hover:text-white hover:underline">Competicion</Link></li>
              <li><Link to="/products?category=Acero inoxidable" className="hover:text-white hover:underline">Acero inoxidable</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 flex flex-col items-center justify-between border-t border-white/10 pt-6 md:flex-row">
          <p className="flex flex-wrap items-center justify-center gap-1 text-sm text-gray-200 md:justify-start">
            <span>© {new Date().getFullYear()} Cris Metal Escapes. Todos los derechos reservados.</span>
          </p>
          <div className="mt-4 flex space-x-6 md:mt-0">
            <Link to="/privacy" className="text-sm text-gray-200 hover:text-white hover:underline">Privacidad</Link>
            <Link to="/terms" className="text-sm text-gray-200 hover:text-white hover:underline">Terminos</Link>
